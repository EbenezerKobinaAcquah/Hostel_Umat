...
function Login() {
  ...
  return (
    <div className=" w-full overall-container">
        ...
        <div className="flex justify-around m-7">
          ...
          <div className="flex items-center link-labels">
            <div className="cursor-pointer flex">
              ...
              <img src="images/down-arrow.png" className="h-4  mr-10"></img>
            </div>
            <div className="cursor-pointer flex">
              <p className="pr-1">Hostels</p>
              <img src="images/down-arrow.png" className="h-4  mr-10"></img>
            </div>
            <div className="cursor-pointer flex">
              <p className="pr-1">Home</p>
            ...
            <div className="cursor-pointer flex">
              <p className="pr-1">Reviews</p>
              <img src="images/down-arrow.png" className="h-4  mr-10"></img>
            </div>
            <div className="cursor-pointer flex">
              <p className="pr-1">Contact Us</p>
              <img src="images/down-arrow.png" className="h-4  mr-10"></img>
            </div>
          </div>
          <div className="">
            ...
            ></input>
            <div className="primary-color absolute top-[10%] right-[6%] w-16 h-16 rounded-full flex justify-center items-center cursor-pointer">
      ...
      {/* <div className="main-component flex justify-center">
